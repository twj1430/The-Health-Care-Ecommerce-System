...
{
    $targetDir = $path;
    $default = $_SESSION['admin_profile_image'];
...
<script>
    $(document).ready(function() {
        ...
        //     // var form = new FormData(document.getElementById('upload_image'));
        //     // var file = document.getElementById('file').files[0];
        //     $.ajax({
        //         url: "../ajax.php",
        //         method: "post",
        //         data: {
        //             edit_profile: $("#admin_id").val(),
        //             admin_name_edit: $("#admin_name").val(),
        //             admin_contact_number_edit: $("#admin_contact_number").val(),
        //             admin_email_edit: $("#admin_email").val(),
        //             admin_address_edit: $("#admin_address").val(),
        //             admin_post_code_edit: $("#admin_post_code").val(),
        //             admin_city_edit: $("#admin_city").val(),
        //             admin_country_edit: $("#admin_country").val(),
        //             admin_profile_image_edit: file
        //         },
        //         dataType: "text",
