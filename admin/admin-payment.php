                                ...
                                <div class="col-lg-12">
                                    <div class="row">
                                            ...
                                            <tr>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <?php
                                                        $sqli = "SELECT * FROM shipping_method where shipping_id='" . $_SESSION['admin_shipping_method'] . "'";
                                                                ...
                                                                <form>
                                                                    <div class="radio">
                                                                        <label style="cursor:pointer">
                                                                            <input type="radio" class="credit_card" name="credit_card" form="shipping" value="Credit Card" required="required" />
                                                                            <i class="helper"></i>Credit Card
                                                                        </label>
                                                                    </div>
                                                                </form>
                                                            </div>
                                                        ...
                                                        <td>
                                                            <div class="row">
                                                                <div class="col-lg-12 py-2">
                                                                    <input type="text" class="form-control" style="border-radius:0;padding:25px" placeholder="Card number">
                                                                </div>

                                                                <div class="col-lg-12 py-2">
                                                                    <input type="text" class="form-control" style="border-radius:0;padding:25px" placeholder="Name on card">
                                                                </div>

                                                                <div class="col-lg-6 py-2">
                                                                    <input type="text" class="form-control" style="border-radius:0;padding:25px" placeholder="Expiration date (MM/YY)">
                                                                </div>

                                                                <div class="col-lg-6 py-2">
                                                                    <input type="text" class="form-control" style="border-radius:0;padding:25px" placeholder="Security Code">
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                        ...
                                        <div class="col-lg-6 py-5">
                                            <button class="btn btn-success" style="padding:15px 30px 15px 30px;border-radius:0;width:100%" id="pay_now" type="submit">PAY NOW</button>
                                        </div>
