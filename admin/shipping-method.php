...
if(isset($_POST['create'])){
    $create_shipping_name = $_POST['name'];
    $create_shipping_price = $_POST['price'];

    $sql = "INSERT into shipping_method(shipping_id, shipping_name, shipping_price, shipping_create_time)values('', '$create_shipping_name', '$create_shipping_price', NOW())";
    $query = mysqli_query($conn, $sql) or die($conn->error.__LINE__);
    echo "<script>window.alert('Create Successful!');window.location.assign('shipping-method.php')</script>";
}

// Edit Shipping
if(isset($_POST['edit'])){
    $edit_shipping_id = $_POST['id'];
    $edit_shipping_name = $_POST['name'];
    $edit_shipping_price = $_POST['price'];

    $sql = "UPDATE shipping_method SET shipping_name = '$edit_shipping_name', shipping_price = '$edit_shipping_price' WHERE shipping_id = '$edit_shipping_id'";
    $query = mysqli_query($conn, $sql) or die($conn->error.__LINE__);
    echo "<script>window.alert('Update Successful!');window.location.assign('shipping-method.php')</script>";
}

// Delete Shipping
if(isset($_GET['delete'])){
    $DeleteSQL = "DELETE FROM shipping_method WHERE shipping_id = '".$_GET['delete']."'";
    $DeleteResult = $conn->query($DeleteSQL) or die($conn->error . __LINE__);
    echo "<script>window.location.assign('shipping-method.php');</script>";
}
?>
        ...
        <div class="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-12" style="padding: 0 20px;">
                    <h4 style="margin-top: 30px;">Shipping Method</h4>
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3">
                            <input type="search" placeholder="Search" name="search_shipping" id="search_shipping" style="margin:10px 90px 10px 0;padding:8px;border:none;width:100%" />
                        </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="shipping-method.php" method="POST">
                                        <label>Name</label>
                    ...
                    <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form action="shipping-method.php" method="POST" enctype="multipart/form-data">                
                    ...
                    <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="deleteModalLabel">Delete Shipping Method</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '.page-link', function() {
            ...
            var query = $('#search_shipping').val();
            load_data(page, query);
        });

        $('#search_shipping').keyup(function() {
            var search = $(this).val();
            if (search != '') {
                load_data(1, search);
            } else {
